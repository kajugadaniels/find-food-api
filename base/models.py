...
class Place(models.Model):
    ...
    province = models.CharField(max_length=500, verbose_name=_('Province'))
    district = models.CharField(max_length=500, verbose_name=_('District'))
    sector = models.CharField(max_length=500, verbose_name=_('Sector'))
    cell = models.CharField(max_length=500, verbose_name=_('Cell'))
    village = models.CharField(max_length=500, verbose_name=_('Village'))
    address = models.CharField(max_length=500, verbose_name=_('Address'))
    latitude = models.FloatField(validators=[RegexValidator(regex=r'^-?([1-8]?\d(\.\d+)?|90(\.0+)?)$', message='Enter a valid latitude (-90 to 90).')], verbose_name=_('Latitude'))
    longitude = models.FloatField(validators=[RegexValidator(regex=r'^-?((1[0-7]\d)|(\d{1,2}))(\.\d+)?$', message='Enter a valid longitude (-180 to 180).')], verbose_name=_('Longitude'))
    main_phone_number = models.CharField(max_length=15, validators=[RegexValidator(regex=r'^\+?1?\d{9,15}$', message='Enter a valid phone number (up to 15 digits).')], verbose_name=_('Main Phone Number'))
    ...
    email = models.EmailField(validators=[EmailValidator()], unique=True, verbose_name=_('Email'))
